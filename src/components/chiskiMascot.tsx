export default function ChiskiMascot({ className }: { className?: string }) {
  return (
    <svg
      viewBox="0 0 128 128"
      xmlns="http://www.w3.org/2000/svg"
      role="img"
      aria-label="Chiski, the wise Chisko owl mascot"
      className={className}
    >
      <defs>
        <linearGradient id="chiskiBodyGrad" x1="0" y1="0" x2="0" y2="1">
      ...
      <circle cx="47" cy="65" r="6" fill="#1E293B" />
